...
function Money(props) {
    ...
    return (
        ...
        >
            <g>
                <path d="m51 32 11-11-19-19-30 30" fill={color} />
                <path
                ...
                <g>
                    <path d="m61.999 30.999h-8.585l9.293-9.292c.188-.188.292-.442.293-.707 0-.266-.105-.52-.293-.708l-19-19c-.391-.391-1.024-.389-1.415 0l-29.708 29.707h-10.586c-.552 0-1 .448-1 1v26c0 .552.448 1 1 1h14.586l3.707 3.707c.189.188.443.294.709.293.265 0 .52-.105.707-.292l3.707-3.707h36.585c.552 0 1-.448 1-1v-26c0-.553-.448-1.001-1-1.001zm-19-27.585 17.586 17.585-10 10h-7.635c-.229-2.561-1.332-4.938-3.172-6.778-4.29-4.288-11.268-4.288-15.556 0-1.841 1.84-2.945 4.218-3.173 6.778h-5.634zm-15.773 27.585c-.135-.649.047-1.344.53-1.827l1.827 1.827zm10.787 0c-.11-.145-.228-.284-.358-.414-1.51-1.511-4.146-1.511-5.655 0l-2.829-2.829c.781-.779 2.048-.779 2.829.001l1.413-1.415c-1.558-1.558-4.096-1.559-5.656 0l-.707-.707-1.415 1.415.708.708c-.879.878-1.268 2.069-1.143 3.242h-2.14c.222-2.025 1.114-3.901 2.577-5.363 3.508-3.51 9.218-3.509 12.728 0 1.461 1.461 2.353 3.338 2.576 5.363h-2.928zm-17.014 29.586-1.585-1.585h3.17zm40-3.585h-58.001v-24h58.001z" />
                    <path d="m28.999 47.999-2 .001c0 2.205 1.794 3.999 4 3.999v1h1.999v-1h.002c2.204 0 3.998-1.794 3.998-4s-1.794-4-3.998-4h-.002v-4h.002c1.102 0 1.998.897 1.998 2h2c0-2.206-1.794-4-3.998-4h-.002v-1h-1.999v1c-2.206 0-4 1.794-4 4 0 2.205 1.794 3.999 4 3.999v4c-1.103.001-2-.896-2-1.999zm0-5.999c0-1.103.896-2 2-2v4c-1.103 0-2-.898-2-2zm3.999 3.999h.002c1.102 0 1.998.897 1.998 2.001 0 1.102-.896 1.999-1.998 1.999h-.002z" />
                    <path d="m31.999 55.999c6.064 0 10.999-4.935 10.999-11s-4.935-11-10.999-11c-6.065.001-10.999 4.935-10.999 11.001 0 6.064 4.934 10.999 10.999 10.999zm0-19.999c4.962 0 8.999 4.037 8.999 9 0 4.962-4.037 9-8.999 9-4.963 0-8.999-4.037-8.999-9s4.036-9 8.999-9z" />
                    <path d="m58.998 53.999v-17.999c0-.553-.447-1-1-1h-11.999v2h10.999v16h-10.999v2h11.999c.553-.001 1-.448 1-1.001z" />
                    <path d="m6 55h11.999v-2h-10.999v-16h11l-.001-2h-12c-.552 0-.999.447-.999 1v18c0 .552.447 1 1 1z" />
                    ...
                    <path d="m43.271 9.414 11.313 11.314-7.778 7.778 1.415 1.415 8.485-8.485c.188-.188.292-.442.292-.708 0-.265-.104-.52-.292-.707l-12.727-12.729c-.391-.391-1.024-.39-1.415 0l-8.485 8.485 1.415 1.415z" />
                    <path
                        d="m44.392 24.677h2v2h-2z"
