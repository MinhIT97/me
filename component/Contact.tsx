...
const Contact = () => {
    ...
    const socialLinks = [
        ...
        { 
            name: 'LinkedIn', 
            url: 'https://www.linkedin.com/in/minh-nguyen-van-a7a2a41a4/', 
                            ...
                            <div className="flex gap-4">
                                {socialLinks.map((social) => (
                                    <a
                                        ...
                                        className="w-10 h-10 rounded-lg flex items-center justify-center transition-all hover:scale-110 hover:-translate-y-1 social-icon-glow"
                                        style={{ 
                                        ...
                                        onMouseEnter={(e) => {
                                            ...
                                            target.style.boxShadow = `0 0 20px ${social.color}66`;
                                            target.style.background = social.color;
                                        }}
                                        onMouseLeave={(e) => {
                                            const target = e.currentTarget as HTMLElement;
